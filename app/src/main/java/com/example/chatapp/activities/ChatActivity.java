...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage() {
        if (recevierUser != null) {
            ...
            if (conversionId != null) {
                ...
                conversion.put(Constants.KEY_RECEIVER_ID, recevierUser.id);
                conversion.put(Constants.KEY_RECEIVER_NAME, recevierUser.name);
                conversion.put(Constants.KEY_RECEIVER_IMAGE, recevierUser.image);
    ...
    private void addConversion(HashMap<String, Object> conversion) {
        database.collection(Constants.KET_COLLECTION_CONVERSATIONS)
                .add(conversion)
    ...
    private void updateConversion(String message) {
        DocumentReference documentReference =
                database.collection(Constants.KET_COLLECTION_CONVERSATIONS).document(conversionId);
